            ...
            <div className="glass relative z-10 w-full max-w-md p-8 rounded-2xl shadow-2xl animate-fade-in">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <button
                        ...
                        className="bg-white/5 border border-gray-600 hover:bg-white/10 text-white py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors"
                    >
